            ...
            <div class="card-body">
                ...
                <form class="needs-validation" id="editForm" method="post" novalidate>
                    ...
                    <div class="form-group mb-3" id="img_url">
                        ...
                        <textarea name="imgUrl" class="form-control" placeholder="请输入图片地址(URL、绝对路径或相对路径)，多个图片地址用分号;分隔" rows="3" required><?php echo htmlspecialchars_decode($Imglist['imgUrl']) ?></textarea>
